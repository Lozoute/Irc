/*
** server_chan.c for MyIrc in /home/lks/rendu/PSU_2014_myirc/auzou_t/
** 
** Made by Thibaud Auzou
** Login   <auzou_t@epitech.net>
** 
** Started on  Tue Apr  7 19:54:39 2015 Thibaud Auzou
** Last update Sun Apr 12 18:51:35 2015 Thibaud Auzou
*/
...
t_chan_list		**chan_list(int action)
{
  ...
  if (action == DESTROY && begin != NULL)
	...
	{
	  tmp = begin->_next;
	  remove_all_users_from_chan(&(begin->_chan));
	  free(begin);
	}
      begin = NULL;
    }
